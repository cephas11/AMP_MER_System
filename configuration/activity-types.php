        ...
        <div class="layout-main">
            ...
            <div class="layout-content">
                <div class="layout-content-body">
                    ...
                    if (in_array("ADD_ACTIVITY_TYPE", $scopes)) {
                        ?>
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-md-10 ">
                                        ...
                                        <table id="activityTbl" class="table table-middle nowrap">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php
                                                    if (in_array("EDIT_ACTIVITY_TYPES", $scopes)) {
                                                        ?>

                                                        <th>Edit </th>
                                                        <?php
                                                    }
                                                    if (in_array("DELETE_ACTIVITY_TYPES", $scopes)) {
                                                        ?>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="updateActivityTypeForm" >
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="region" class="control-label">Name:</label>
                                        <input type="text" class="form-control" name="name" id="activityTypeName" required>
                                    </div>
                                    ...
                                    <input type="hidden" class="form-control" name="tablename" value="activity_types">
