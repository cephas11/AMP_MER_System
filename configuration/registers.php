        ...
        <div class="layout-main">
            ...
            <div class="layout-content">
                <div class="layout-content-body">
                    ...
                    if (in_array("ADD_REGISTERS", $scopes)) {
                        ?>
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="col-md-10 ">
                ...
                <div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form method="post" id="deleteRegistrarForm">
                                <div class="modal-body">
                                    <div>
                                        <p>
                                            Are you sure you want to delete this registrar?.<span class="holder" id="registrarholder"></span> 
                                        </p>
                                    </div>
                                    <input type="hidden" id="code" name="code"/>
                                    <input type="hidden"  name="type" value="deleteRegistrar"/>
