        ...
        success: function (data) {
            ...
            if (obj.length == 0) {
                ...
                $.each(obj, function (key, value) {
                    ...
                    r[++j] = '<td><a  href="beneficiary-financial-services-tracker?code=' + value.code + '" class="btn btn-outline-info btn-sm btn-edit"><i class="fa fa-edit""></i><span class="hidden-md hidden-sm hidden-xs">View </span></a></td>';
