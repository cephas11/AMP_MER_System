...
<html lang="en">
    ...
    <body class="layout layout-header-fixed">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive" >
                                            <table id="auditTbl" class="table table-bordered table-striped table-nowrap " cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>Username</th>
                                                        <th>Activity </th>
       ...
       <script src="js/login.js"></script>
        <!--https://cdn.datatables.net/buttons/1.3.1js/buttons.bootstrap4.min.js
        //cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js
//cdn.rawgit.com/bpampuch/pdfmake/0.1.27/build/pdfmake.min.js

//cdn.datatables.net/buttons/1.3.1js/buttons.html5.min.js-->
