...
<html lang="en">
    <head>
        ...
        <title>Financial Service Report</title>
            ...
            <div class="layout-content">
                <div class="layout-content-body">
                    <div class="row gutter-xs">
                        <div class="">
                            <strong> Financial Services Report</strong>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive" >
                                            <table id="financialTbl" class="table table-bordered table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>Gender</th>
                                                        <th>   Financial Type
                                                        </th>
                                                        <th > Number of People Receiving 
                                                        </th>
